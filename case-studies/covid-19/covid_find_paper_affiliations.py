...
with open('PATH_TO_INTEMEDIATE_RESULTS/papers_covid_openaireids.json', 'r') as f:
...
with open('PATH_TO_INTEMEDIATE_RESULTS/papers_covid_affiliated_org_oaids.json', 'w') as f:
    json.dump(found_data, f, indent=1)

""" SECOND PASS - GET THE ORG NAMES AND IDENTIFIERS"""

# Load the affiliations org oaids
with open('PATH_TO_INTEMEDIATE_RESULTS/papers_covid_affiliated_org_oaids.json', 'r') as f:
...
# Save the found data as a json
with open('PATH_TO_INTEMEDIATE_RESULTS/papers_covid_affiliated_org_oaids_meta.json', 'w') as f:
...
# Save the found data as a json
with open('PATH_TO_INTEMEDIATE_RESULTS/papers_covid_affiliated_org_oaids_pids.json', 'w') as f:
