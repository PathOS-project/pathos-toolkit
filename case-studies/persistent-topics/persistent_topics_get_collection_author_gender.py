...
In this file we are going to get the gender from the authors of the collections used in the Impact of Open Access Routes on Topic Persistence Case Study.
